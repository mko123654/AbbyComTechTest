...
CREATE TABLE `question_level` (
  `question_level_id` int NOT NULL AUTO_INCREMENT COMMENT '題目難易度代碼',
  `question_level_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL COMMENT '題目難易度名稱',
  `question_level_description` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL COMMENT '題目難易度描述',
  PRIMARY KEY (`question_level_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='題目難易度資料表';
...
INSERT INTO `question_level` VALUES (1,'high','難'),(2,'middle','中'),(3,'low','易');
